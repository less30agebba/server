...
import com.pengpenghuyu.supportplat.agentplatform.main.interceptor.AppInterceptor;
import com.pengpenghuyu.supportplat.agentplatform.main.interceptor.AuthConsumerInterceptor;
import com.pengpenghuyu.supportplat.agentplatform.main.interceptor.AuthManagerInterceptor;
import com.pengpenghuyu.supportplat.agentplatform.main.interceptor.LogInterceptor;
...
public class MvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new AppInterceptor())
                .addPathPatterns("/consumer/**", "/manager/**","/api/gather/**")
                .addPathPatterns("/agent/**")
                .excludePathPatterns("/manager/auth/login")
                .excludePathPatterns("/manager/auth/logout");
